...
def get_total_called_functions(func) -> Tuple[Set[Callable], Set[Callable]]:
    ...
    if visitor.non_lib_objs:
        return {func}, visitor.lib_objs
    visitor.non_lib_objs.update({func}) # faster than union
