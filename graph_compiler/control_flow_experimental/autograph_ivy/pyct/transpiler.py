...
from control_flow_experimental.autograph_ivy.pyct import loader
from control_flow_experimental.autograph_ivy.pyct import naming
...
class GenericTranspiler(object):
    ...
    def transform(self, obj, user_context=None):
