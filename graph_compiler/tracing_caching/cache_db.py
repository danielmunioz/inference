...
class CacheDB:
    ...
    def insert_cache(self, code_loc, code_line, func_def, args_str, kwargs_str, compile_kwargs_str, source_code_str, graph_fn_str, constants, functions):
        query = f"""
        INSERT INTO
            cache (code_loc, code_line, func_def, args_str, kwargs_str, compile_kwargs_str, source_code_str, graph_fn_str, constants, functions)
            VALUES
    ...
    def insert_cache_and_select_all(self, code_loc, code_line, func_def, graph_fn_str, args, kwargs, source_code, constants, functions):
        self.insert_cache(code_loc, code_line, func_def,
                          graph_fn_str, args, kwargs, source_code, constants, functions)
