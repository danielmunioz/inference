...
from types import FunctionType, ModuleType, BuiltinMethodType

# local
import ivy
from graph_compiler import globals as glob
from graph_compiler import source_gen as sg
from graph_compiler.conversion import is_array
from graph_compiler.tracked_var_proxy import TrackedVarProxy, _to_ignore
...
def _wraps(fn, from_tracked_var):
    """
